...
- **Retry loop pattern**: Implementing recovery as a Python loop _around_ the Deep Agents graph — after each run, if tests fail, re-invoke with failure output appended to the conversation
