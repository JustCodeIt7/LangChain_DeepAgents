...
| `OPENAI_BASE_URL`     | _(empty)_                | Optional override for OpenAI-compatible endpoints               |
...
| `DEEPCODER_AUTO_APPROVE`  | _(empty)_           | `1` skips every approval prompt — handy for demos, a bad idea near a repo you care about |
